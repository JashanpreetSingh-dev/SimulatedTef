...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'results.modelAnswerReference': 'Référence - Réponse modèle',
    'results.modelAnswerDescription': 'Exemple de réponse de qualité pour référence',
    ...
    'results.transcriptUser': 'Vous',
    'results.transcriptExaminer': 'Examinateur',
    ...
    // Warmup
    'warmup.title': 'Échauffement oral quotidien',
    'warmup.subtitle': 'Une petite séance de conversation guidée chaque jour pour garder ton français en mouvement.',
    'warmup.streak': '{count} jour(s)',
    'warmup.topicLabel': 'Sujet du jour',
    'warmup.topicLoadError': 'Impossible de charger le sujet du jour.',
    'warmup.configLoadError': "Impossible de charger la configuration de l'échauffement.",
    'warmup.startError': 'Impossible de démarrer la séance. Veuillez réessayer dans un instant.',
    'warmup.alreadyDone': "Déjà fait pour aujourd'hui",
    'warmup.start': 'Commencer',
    'warmup.stop': 'Terminer',
    'warmup.connecting': 'Connexion...',
    'warmup.greatSession': 'Belle séance !',
    'warmup.todayFeedback': 'Voilà ton retour du jour.',
    'warmup.streakLabel': 'Série : {count} jour(s)',
    'warmup.tomorrow': 'Pour demain →',
    'warmup.back': 'Retour',
    'warmup.backToDashboard': 'Retour au tableau de bord',
    'warmup.selectTopic': 'Choisir un sujet',
  ...
  en: {
    ...
    'results.modelAnswerReference': 'Reference - Model Answer',
    'results.modelAnswerDescription': 'Example of a high-quality answer for reference',
    ...
    'results.transcriptUser': 'You',
    'results.transcriptExaminer': 'Examiner',
    ...
    // Warmup
    'warmup.title': 'Daily Oral Warm-Up',
    'warmup.subtitle': 'A short guided conversation session each day to keep your French moving.',
    'warmup.streak': '{count} day(s)',
    'warmup.topicLabel': 'Topic of the day',
    'warmup.topicLoadError': 'Unable to load today\'s topic.',
    'warmup.configLoadError': 'Unable to load warm-up configuration.',
    'warmup.startError': 'Unable to start the session. Please try again in a moment.',
    'warmup.alreadyDone': 'Already done for today',
    'warmup.start': 'Start',
    'warmup.stop': 'End',
    'warmup.connecting': 'Connecting...',
    'warmup.greatSession': 'Great session!',
    'warmup.todayFeedback': "Here's your feedback for today.",
    'warmup.streakLabel': 'Streak: {count} day(s)',
    'warmup.tomorrow': 'For tomorrow →',
    'warmup.back': 'Back',
    'warmup.backToDashboard': 'Back to dashboard',
    'warmup.selectTopic': 'Select a topic',
