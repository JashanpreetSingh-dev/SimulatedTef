        ...
        contents: [{
          parts: [{
            ...
            text: [
              ...
              "",
              "STRICT TRANSCRIPTION RULES (VERY IMPORTANT):",
              "- Only transcribe words that are actually present in the AUDIO.",
              "- If the recording is short, the transcript MUST also be short.",
              "- Do NOT invent, extend, or continue the conversation beyond what is heard.",
              "- Do NOT repeat the same question or sentence many times unless the AUDIO itself clearly repeats it.",
              "- The \"Examiner:\" lines must reflect ONLY what the examiner voice says in the audio, nothing more.",
              "",
