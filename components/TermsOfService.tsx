    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12">
      <div className="bg-slate-900/40 backdrop-blur-sm rounded-3xl border border-slate-800/50 p-6 md:p-10 lg:p-12">
          ...
          <div className="prose prose-invert prose-slate max-w-none space-y-6 text-slate-300 leading-relaxed">
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">1. Service Description</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">2. User Accounts and Responsibilities</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">3. Subscription Terms and Payment Processing</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">4. Trial Periods and Pack Purchases</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">5. Usage Limits and Restrictions</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">6. AI Evaluation Disclaimers</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">7. Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">8. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">9. Service Modifications</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">10. Account Termination</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">11. Contact Information</h2>
              <p>
