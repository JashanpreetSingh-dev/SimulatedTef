    ...
    <div className="grid md:grid-cols-2 gap-4 md:gap-6">
      ...
      {!isD2C && (
        ...
        >
          ...
          <p className="text-blue-100 text-xs leading-relaxed mb-2 md:mb-3">{t('practice.readingSubtitle')}</p>
          <div className="flex items-center text-white font-bold text-xs">
            {t('common.startPracticing')} <span className="ml-1.5">→</span>
          </div>
        </div>
      ...
      {!isD2C && (
        ...
        >
          ...
          <p className="text-green-100 text-xs leading-relaxed mb-2 md:mb-3">{t('practice.listeningSubtitle')}</p>
          <div className="flex items-center text-white font-bold text-xs">
            {t('common.startPracticing')} <span className="ml-1.5">→</span>
          </div>
        </div>
