    ...
    >
      ...
      >
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-black text-slate-800 dark:text-slate-100 mb-4">Prêt à commencer ?</h2>
        ...
        <div className="space-y-4 mb-6">
          <div className="p-6 bg-indigo-100/70 dark:bg-slate-700/50 rounded-xl border border-slate-200 dark:border-slate-600">
            <h3 className="text-slate-800 dark:text-slate-100 font-semibold mb-4">Informations importantes</h3>
