    ...
    >
      ...
      >
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-black text-slate-800 dark:text-slate-100 mb-4">Upgrade Pack</h2>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="p-6 bg-indigo-100/70 dark:bg-slate-700/50 rounded-xl border border-slate-200 dark:border-slate-600">
            <h3 className="text-slate-800 dark:text-slate-100 font-semibold mb-4">Current Pack: {getPackName(currentPack.type)}</h3>
          ...
          <div className="p-6 bg-indigo-100 dark:bg-indigo-900/30 rounded-xl border border-indigo-200 dark:border-indigo-700">
            <h3 className="text-slate-800 dark:text-slate-100 font-semibold mb-4">New Pack: {newPack.name}</h3>
          ...
          {/* Warning */}
          <div className="p-6 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-xl">
        ...
        <div className="flex gap-4">
          <button
            onClick={onClose}
            className="flex-1 py-4 px-6 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 transition-colors text-sm font-semibold rounded-lg border border-slate-200 dark:border-slate-600 hover:border-slate-300 dark:hover:border-slate-500"
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            className="flex-1 py-4 px-6 bg-indigo-400 dark:bg-indigo-500 text-white dark:text-white rounded-lg text-sm font-semibold hover:bg-indigo-500 dark:hover:bg-indigo-600 transition-colors"
          >
            Yes, Replace Pack
          </button>
        </div>
