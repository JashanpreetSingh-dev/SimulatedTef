...
export const ExamSimulator: React.FC = () => {
  ...
  if (evaluation) {
    ...
    return (
      <div className="bg-indigo-100/70 dark:bg-slate-800/50 rounded-[3rem] shadow-xl border border-slate-200 dark:border-slate-700 p-8 md:p-12 animate-in fade-in zoom-in duration-300 transition-colors">
        <div className="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
          ...
          <div className="text-center bg-indigo-400 dark:bg-indigo-500 text-white dark:text-white rounded-[2rem] p-6 min-w-[160px] shadow-lg shadow-indigo-400/20 dark:shadow-indigo-500/20">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-[2rem] p-8 border border-emerald-100 dark:border-emerald-800 transition-colors">
            <h3 className="font-black text-[10px] uppercase text-emerald-400 dark:text-emerald-300 mb-6 tracking-widest flex items-center gap-2">
          ...
          <div className="bg-rose-50 dark:bg-rose-900/20 rounded-[2rem] p-8 border border-rose-100 dark:border-rose-800 transition-colors">
        ...
        <div className="space-y-6">
          <div className="bg-indigo-100/70 dark:bg-slate-700/50 p-8 rounded-[2rem] border border-slate-200 dark:border-slate-600 transition-colors">
            <h4 className="font-black text-[10px] uppercase text-slate-500 dark:text-slate-400 mb-4 tracking-[0.2em]">Feedback Global</h4>
            <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed italic">"{evaluation.feedback}"</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-8 border border-slate-200 dark:border-slate-600 rounded-[2rem] bg-indigo-100/70 dark:bg-slate-700/50 transition-colors">
              <h4 className="font-black text-[10px] uppercase text-slate-500 dark:text-slate-400 mb-3 tracking-[0.2em]">Grammaire & Syntaxe</h4>
              <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">{evaluation.grammarNotes}</p>
            </div>
            <div className="p-8 border border-slate-200 dark:border-slate-600 rounded-[2rem] bg-indigo-100/70 dark:bg-slate-700/50 transition-colors">
              <h4 className="font-black text-[10px] uppercase text-slate-500 dark:text-slate-400 mb-3 tracking-[0.2em]">Richesse Lexicale</h4>
        ...
        <button 
          ...
          className="mt-12 w-full bg-slate-900 dark:bg-slate-700 text-white dark:text-slate-100 py-6 rounded-[2.5rem] font-black text-xs uppercase tracking-[0.3em] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-slate-900/10 dark:shadow-slate-700/20"
        >
          Nouvel Entraînement
        </button>
      </div>
  ...
  if (simulationMode && scenario) {
    return (
      <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
        <button onClick={() => setSimulationMode(null)} className="text-indigo-400 dark:text-indigo-300 font-black text-[10px] uppercase tracking-widest flex items-center gap-2 hover:opacity-70 transition-opacity mb-4">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <button 
              ...
              className="group bg-indigo-100/70 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 p-10 rounded-[3rem] text-left hover:border-indigo-300 dark:hover:border-indigo-600 transition-all flex flex-col h-full shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              <div className="mt-8 text-[10px] font-black text-blue-400 dark:text-blue-300 uppercase tracking-widest">4 minutes • Live Mic</div>
            </button>
            <button 
            ...
            >
              ...
              <div className="mt-8 text-[10px] font-black text-emerald-400 dark:text-emerald-300 uppercase tracking-widest">8 minutes • Live Mic</div>
            </button>
            <button 
              onClick={() => startSimulation('full')} 
              disabled={loading || usageLoading}
              className="group bg-indigo-400 dark:bg-indigo-500 p-10 rounded-[3rem] text-left hover:shadow-2xl hover:shadow-indigo-400/30 dark:hover:shadow-indigo-500/30 transition-all flex flex-col h-full text-white dark:text-white disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              <div className="mt-8 text-[10px] font-black text-white/50 dark:text-white/70 uppercase tracking-widest">12 minutes • Session réelle</div>
            </button>
          </div>
        </div>
      </div>
