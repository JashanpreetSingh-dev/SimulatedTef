...
export function ReadingPracticeCard() {
  ...
  return (
    <div
      id="tour-reading-practice-card"
      className="h-full bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl md:rounded-3xl p-4 md:p-6 shadow-lg hover:shadow-xl hover:shadow-blue-500/20 transition-all group cursor-pointer"
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-2 mb-1.5 md:mb-2">
        <h3 className="text-base md:text-xl font-bold text-white">{t('modules.reading')}</h3>
      ...
      <p className="text-blue-100 text-xs md:text-sm leading-relaxed mb-3 md:mb-4">
        {t('dashboard.readingCardDescription')}
      </p>
